...
use App\Http\Controllers\Citizen\CitizenCryptoPaymentController;
...
/*
|--------------------------------------------------------------------------
| Public Tracking / QR Routes
|--------------------------------------------------------------------------
*/

Route::get('/track/{qrCode}', [TrackingController::class, 'show'])
    ->name('tracking.show');
...
Route::prefix('admin')->name('admin.')->middleware(['isconnected', 'otp', 'isAdmin'])->group(function () {
    ...
    Route::post('municipalities/{id}/toggle-status', [AdminMunicipalityController::class, 'toggleStatus'])
        ->name('municipalities.toggle-status');

    Route::resource('offices', AdminOfficeController::class);
    Route::post('offices/{id}/toggle-status', [AdminOfficeController::class, 'toggleStatus'])
        ->name('offices.toggle-status');

    Route::resource('office-staff', AdminOfficeStaffController::class);
    Route::post('office-staff/{id}/toggle-status', [AdminOfficeStaffController::class, 'toggleStatus'])
        ->name('office-staff.toggle-status');
...
Route::prefix('office')->name('office.')->middleware(['isconnected', 'otp', 'isOfficeStaff'])->group(function () {
    ...
    Route::get('services/{service}/required-documents/create', [OfficeRequiredDocumentController::class, 'create'])
        ->name('required-documents.create');

    Route::post('services/{service}/required-documents', [OfficeRequiredDocumentController::class, 'store'])
        ->name('required-documents.store');

    Route::get('required-documents/{id}/edit', [OfficeRequiredDocumentController::class, 'edit'])
        ->name('required-documents.edit');

    Route::put('required-documents/{id}', [OfficeRequiredDocumentController::class, 'update'])
        ->name('required-documents.update');

    Route::delete('required-documents/{id}', [OfficeRequiredDocumentController::class, 'destroy'])
    ...
    Route::post('requests/{id}/documents', [OfficeRequestController::class, 'uploadDocument'])
        ->name('requests.documents.store');

    Route::get('requests/{id}/documents/{documentId}/download', [OfficeRequestController::class, 'downloadDocument'])
        ->name('requests.documents.download');

    Route::post('requests/{id}/generated-documents', [OfficeRequestController::class, 'generateDocument'])
        ->name('requests.generated-documents.store');

    Route::get('requests/{id}/generated-documents/{documentId}/download', [OfficeRequestController::class, 'downloadGeneratedDocument'])
    ...
    Route::get('appointments', [OfficeAppointmentController::class, 'index'])
        ->name('appointments.index');

    Route::get('appointments/{id}', [OfficeAppointmentController::class, 'show'])
        ->name('appointments.show');

    Route::put('appointments/{id}', [OfficeAppointmentController::class, 'update'])
        ->name('appointments.update');

    Route::get('feedback', [OfficeFeedbackController::class, 'index'])
        ->name('feedback.index');

    Route::get('feedback/{id}', [OfficeFeedbackController::class, 'show'])
        ->name('feedback.show');

    Route::put('feedback/{id}', [OfficeFeedbackController::class, 'reply'])
        ->name('feedback.reply');

    Route::get('chats', [OfficeChatController::class, 'index'])
        ->name('chats.index');

    Route::get('chats/{id}', [OfficeChatController::class, 'show'])
        ->name('chats.show');

    Route::get('chats/{id}/messages', [OfficeChatController::class, 'messages'])
        ->name('chats.messages.index');

    Route::post('chats/{id}/messages', [OfficeChatController::class, 'storeMessage'])
        ->name('chats.messages.store');

    Route::get('payments', [OfficePaymentController::class, 'index'])
        ->name('payments.index');

    Route::get('payments/{id}', [OfficePaymentController::class, 'show'])
        ->name('payments.show');

    Route::get('notifications', [OfficeNotificationController::class, 'index'])
        ->name('notifications.index');

    Route::post('notifications', [OfficeNotificationController::class, 'store'])
        ->name('notifications.store');

    Route::put('notifications/{id}/read', [OfficeNotificationController::class, 'markRead'])
...
Route::get('/discover/offices/{id}', [DiscoveryController::class, 'showOffice'])
    ->name('discovery.offices.show');

Route::get('/discover/services/{id}', [DiscoveryController::class, 'showService'])
    ->name('discovery.services.show');
...
Route::prefix('citizen')->name('citizen.')->middleware(['isconnected', 'otp'])->group(function () {
    ...
    Route::get('profile/id-document', [CitizenProfileController::class, 'viewIdDocument'])
        ->name('profile.id-document');
    Route::get('profile', [CitizenProfileController::class, 'show'])
        ->name('profile.show');

    Route::get('profile/edit', [CitizenProfileController::class, 'edit'])
        ->name('profile.edit');

    Route::put('profile', [CitizenProfileController::class, 'update'])
        ->name('profile.update');
    ...
    Route::middleware('citizenVerified')->group(function () {
        ...
        Route::get('requests', [CitizenRequestTrackingController::class, 'index'])
            ->name('requests.index');

        Route::get('requests/{id}', [CitizenRequestTrackingController::class, 'show'])
            ->name('requests.show');
