        ...
        <form action="{{ route('citizen.profile.update') }}" method="POST" enctype="multipart/form-data" class="form-card">
            ...
            <section class="form-section">
                <div class="section-header">
                    ...
                    <p>Upload a clear national ID image or PDF. The system will automatically crop, enhance, and read it using OCR.space.</p>
                </div>
                ...
                <div class="form-grid">
                    <div class="form-field full-width">
                        ...
                        <span class="help-text">
                            ...
                            The system will try to detect the national ID number and date of birth automatically.
                        </span>

                        <div class="api-note">
                            After you submit, Laravel sends the ID to OCR.space in English and Arabic.
                            The service automatically enhances the image and checks the full ID, middle section, and bottom section.
                        </div>

                        <div class="warning-note">
                            For best results, upload the ID only, not a large photo with background.
                            Make sure the image is straight, clear, and well-lit.
                        </div>
                    </div>
                </div>
            </section>
